...
public class ListagemForma extends AListagem<FinForma> {
	...
	public void inicializar() {
		// campos
		FieldDef[] fd = new FieldDef[] { new IntegerFieldDef("finFormaId"), new StringFieldDef("finFormaDescricao"), new BooleanFieldDef("finFormaTef"), new BooleanFieldDef("finFormaVinculado"),
				new BooleanFieldDef("finFormaDebito"), new StringFieldDef("finFormaRede"), new BooleanFieldDef("finFormaPagar"), new BooleanFieldDef("finFormaReceber") };
		...
		BaseColumnConfig[] bcc = new BaseColumnConfig[] { ccId, ccDescricao, ccTef, ccVinculado, ccDebito, ccRede, ccPagar, ccReceber };
