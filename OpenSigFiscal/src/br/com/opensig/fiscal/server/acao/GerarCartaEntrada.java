...
public class GerarCartaEntrada extends Chain {
	...
	public GerarCartaEntrada(Chain next, CoreService servico, FisNotaEntrada entrada, String obs, Autenticacao auth) throws OpenSigException {
		super(next);
	...
	public void execute() throws OpenSigException {
		...
		entrada.setFisNotaEntradaXmlCarta(xml);
		// envia o evento
		EnviarCartaEntrada cartaEntrada = new EnviarCartaEntrada(next, new FiscalServiceImpl<FisNotaEntrada>(auth), entrada, auth);
		cartaEntrada.execute();
	}
