...
public class ListagemEcfVenda extends AListagem<ComEcfVenda> {
	...
	public void inicializar() {
		...
		ColumnConfig ccData = new ColumnConfig(OpenSigCore.i18n.txtData(), "comEcfVendaData", 100, true, DATAHORA);
	...
	public void irPara() {
		...
		MenuItem itemTroca = gerarFuncao(troca, "comEcfVenda.comEcfVendaId", "comEcfVendaId");
		if (itemTroca != null) {
