...
public class ListagemValidarCompra {
	...
	public ListagemValidarCompra(ComCompra compra, Dados dados) {
		this.compra = compra;
	...
	private Store getDadosProdutos() {
		...
		Renderer novo = new Renderer() {
			public String render(Object value, CellMetadata cellMetadata, Record record, int rowIndex, int colNum, Store store) {
				...
				if (value != null && gridProdutos.getModelos().getDataIndex(colNum).equals("prodEmbalagem.prodEmbalagemId")) {
					record = UtilClient.getRegistro(gridProdutos.getStoreEmbalagem(), "prodEmbalagemId", value.toString());
