				...
				mask : function(mask, settings) {
					...
					return this
							.each(function() {
								...
								var ignore = false; // Variable for ignoring
								// control
								// keys
								var focusText = input.val();

								input.data("buffer", buffer).data("tests",
										tests);
								...
								function keydownEvent(e) {
									...
									// backspace, delete, and escape get special
									// treatment
									if (k == 8 || k == 46
											|| (iPhone && k == 127)) {// backspace/delete
								...
								function keypressEvent(e) {
									...
									if (e.ctrlKey || e.altKey || e.metaKey) {// Ignore
										return true;
									} else if ((k >= 32 && k <= 125) || k > 186) {// typeable
										// characters
								...
								function checkVal(allow) {
									...
									if (!allow
										...
										writeBuffer();
										if (!allow)
											input.val(input.val().substring(0,
													lastMatch + 1));
									}
