...
if(Ext.ux.UploadDialog.Dialog) {
	Ext.apply(Ext.ux.UploadDialog.Dialog.prototype.i18n, {
		title: 'Janela de Envio de Arquivos',
		state_col_title: 'Status',
		state_col_width: 50,
		filename_col_title: 'Nome Arquivo',
		filename_col_width: 350,  
		note_col_title: 'Resposta',
		note_col_width: 100,
		add_btn_text: 'Adicionar',
		add_btn_tip: 'Adiciona um arquivo na listagem.',
		remove_btn_text: 'Remover',
		remove_btn_tip: 'Remove um arquivo da listagem.',
		reset_btn_text: 'Limpar',
		reset_btn_tip: 'Limpa a listagem.',
		upload_btn_start_text: 'Enviar',
		upload_btn_stop_text: 'Parar',
		upload_btn_start_tip: 'Enviando arquivos da listagem para o servidor.',
		upload_btn_stop_tip: 'Parar Envio.',
		close_btn_text: 'Fechar',
		close_btn_tip: 'Fechar a janela.',
		progress_waiting_text: 'Aguarde...',
		progress_uploading_text: 'Enviando: {0} de {1} arquivos completos.',
		error_msgbox_title: 'Erro',
		permitted_extensions_join_str: ',',
		err_file_type_not_permitted: 'O arquivo selecionado nao tem sua extensão permitida.<br/>Por favor selecione um arquivo com uma destas extensões:<br/><b>{1}</b>',
		note_queued_to_upload: 'Aguardando envio.',
		note_processing: 'Enviando...',
		note_upload_failed: 'Servidor nao encontrado ou erro interno ocorrido.',
		note_upload_success: 'Sucesso no envio.',
		note_upload_error: 'Erro no envio.',
		note_aborted: 'Cancelado pelo usuário.'
	});
}